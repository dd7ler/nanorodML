...
try
    mex -Dchar16_t=uint16_t cpd_P.c;
    mex -Dchar16_t=uint16_t cpd_Pappmex.c;
    mex -Dchar16_t=uint16_t cpd_Pcorrespondence.c;
...
try
    mex -Dchar16_t=uint16_t fgt_model.c;
    mex -Dchar16_t=uint16_t fgt_predict.c;
