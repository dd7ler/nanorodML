% Spot 33 cross polarization 10x database entry
...
% Load in IRIS images
irisFname = '/Users/derin/nanorodML/imageData/cross/10x/PolStack_c1_141954.mat';
...
% Load 50x
temp = load('/Users/derin/nanorodML/database/cross/spot33cross20x.mat');
fiftyx = temp.results;
...
% save if no errors
save('/Users/derin/nanorodML/database/cross/spot33cross10x.mat', 'results');
