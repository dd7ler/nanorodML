% Spot 05 cross polarization 10x database entry
...
% Load in IRIS images
irisFname = '/Users/derin/nanorodML/imageData/cross/10x/PolStack_c1_141752.mat';
...
% Load 50x
temp = load('/Users/derin/nanorodML/database/cross/spot05cross20x.mat');
fiftyx = temp.results;
...
% save if no errors
save('/Users/derin/nanorodML/database/cross/spot05cross10x.mat', 'results');
