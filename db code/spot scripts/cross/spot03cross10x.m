% Spot 03 cross polarization 10x database entry
...
% Load 50x
temp = load('/Users/derin/nanorodML/database/cross/spot03cross20x.mat');
fiftyx = temp.results;
...
% save if no errors
save('/Users/derin/nanorodML/database/cross/spot03cross10x.mat', 'results');
