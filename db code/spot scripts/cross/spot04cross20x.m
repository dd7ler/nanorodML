% Spot 04 cross polarization 20x database entry
...
% Load 50x
temp = load('/Users/derin/nanorodML/database/cross/spot04cross50x.mat');
fiftyx = temp.results;
...
% save if no errors
save('/Users/derin/nanorodML/database/cross/spot04cross20x.mat', 'results');
