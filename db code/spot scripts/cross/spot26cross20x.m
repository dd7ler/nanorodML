% Spot 26 cross polarization 20x database entry
...
% Load 50x
temp = load('/Users/derin/nanorodML/database/cross/spot26cross50x.mat');
fiftyx = temp.results;
...
% save if no errors
save('/Users/derin/nanorodML/database/cross/spot26cross20x.mat', 'results');
