% Spot 33 cross polarization 20x database entry
...
% Load in IRIS images
irisFname = '/Users/derin/nanorodML/imageData/cross/20x/PolStack_c5c6_133846.mat';
...
% Load 50x
temp = load('/Users/derin/nanorodML/database/cross/spot33cross50x.mat');
fiftyx = temp.results;
...
% save if no errors
save('/Users/derin/nanorodML/database/cross/spot33cross20x.mat', 'results');
