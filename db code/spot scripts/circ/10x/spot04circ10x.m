% Spot 3 circular polarization 10x database entry
...
% Load 50x
temp = load('/Users/derin/nanorodML/database/spot04circ20x.mat');
fiftyx = temp.results;
...
% save if no errors
save('/Users/derin/nanorodML/database/spot04circ10x.mat', 'results');
