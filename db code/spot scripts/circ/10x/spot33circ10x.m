% Spot 33 circular polarization 10x database entry
...
% Load in IRIS images
irisFname = '/Users/derin/nanorodML/imageData/circular/2015-6-15 z stacks/10x/c1234_3/c1234_3_MMStack.ome.tif';
...
% Load 50x
temp = load('/Users/derin/nanorodML/database/spot33circ20x.mat');
fiftyx = temp.results;
...
% save if no errors
save('/Users/derin/nanorodML/database/spot33circ10x.mat', 'results');
