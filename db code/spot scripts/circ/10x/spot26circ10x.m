% Spot 26 circular polarization 10x database entry
...
% Load in IRIS images
irisFname = '/Users/derin/nanorodML/imageData/circular/2015-6-15 z stacks/10x/c1234_1/c1234_1_MMStack.ome.tif';
...
% Load 50x
temp = load('/Users/derin/nanorodML/database/spot26circ20x.mat');
fiftyx = temp.results;
fiftyx.metadata.mag = 20; % backwards compatibility hack for testing
...
% save if no errors
save('/Users/derin/nanorodML/database/spot26circ10x.mat', 'results');
