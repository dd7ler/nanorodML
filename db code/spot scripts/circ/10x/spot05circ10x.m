...
% Load in IRIS images
irisFname = '/Users/derin/nanorodML/imageData/circular/2015-6-15 z stacks/10x/c1234_2/c1234_2_MMStack.ome.tif';
...
% Load 50x
temp = load('/Users/derin/nanorodML/database/spot05circ20x.mat');
fiftyx = temp.results;
...
% save if no errors
save('/Users/derin/nanorodML/database/spot05circ10x.mat', 'results');
