% Spot 25 circular polarization 50x database entry
...
% Load in IRIS images
irisFname = '/Users/derin/nanorodML/imageData/circular/2015-6-15 z stacks/50x/c4_1/c4_1_MMStack.ome.tif';
...
% get composite image
fList = regexpdir('/Users/derin/nanorodML/imageData/sem/spot25', '^.*\.tif$');
...
% save if no errors
save('/Users/derin/nanorodML/database/spot25circ50x.mat', 'results');
