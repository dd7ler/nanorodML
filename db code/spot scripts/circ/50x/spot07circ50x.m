% Spot 7 circular polarization 50x database entry
...
% Load in IRIS images
irisFname = '/Users/derin/nanorodML/imageData/circular/2015-6-15 z stacks/50x/c1_7/c1_7_MMStack.ome.tif';
...
% get composite image
fList = regexpdir('/Users/derin/nanorodML/imageData/sem/spot7', '^.*\.tif$');
...
% save if no errors
save('/Users/derin/nanorodML/database/spot07circ50x.mat', 'results');
