% Spot 19 circular polarization 50x database entry
...
% Load in IRIS images
irisFname = '/Users/derin/nanorodML/imageData/circular/2015-6-15 z stacks/50x/c3_3/c3_3_MMStack.ome.tif';
...
% get composite image
fList = regexpdir('/Users/derin/nanorodML/imageData/sem/spot19', '^.*\.tif$');
...
% save if no errors
save('/Users/derin/nanorodML/database/spot19circ50x.mat', 'results');
