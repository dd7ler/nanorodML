% Spot 6 circular polarization 50x database entry
...
% Load in IRIS images
irisFname = '/Users/derin/nanorodML/imageData/circular/2015-6-15 z stacks/50x/c1_6/c1_6_MMStack.ome.tif';
...
% get composite image
fList = regexpdir('/Users/derin/nanorodML/imageData/sem/spot6', '^.*\.tif$');
...
% save if no errors
save('/Users/derin/nanorodML/database/spot06circ50x.mat', 'results');
