...
% Load in IRIS images
irisFname = '/Users/derin/nanorodML/imageData/circular/2015-6-15 z stacks/50x/c1_3/c1_3_MMStack.ome.tif';
...
% get composite image
fList = regexpdir('/Users/derin/nanorodML/imageData/sem/spot3', '^.*\.tif$');
...
% save if no errors
save('/Users/derin/nanorodML/database/spot03circ50x.mat', 'results');
