% Spot 9 circular polarization 50x database entry
...
% Load in IRIS images
irisFname = '/Users/derin/nanorodML/imageData/circular/2015-6-15 z stacks/50x/c2_1/c2_1_MMStack.ome.tif';
...
% get composite image
fList = regexpdir('/Users/derin/nanorodML/imageData/sem/spot9', '^.*\.tif$');
...
% save if no errors
save('/Users/derin/nanorodML/database/spot09circ50x.mat', 'results');
