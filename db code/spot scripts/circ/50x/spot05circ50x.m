...
% Load in IRIS images
irisFname = '/Users/derin/nanorodML/imageData/circular/2015-6-15 z stacks/50x/c1_5/c1_5_MMStack.ome.tif';
...
SEMdata.magScaledown = 14.8;
SEMdata.theta = 146;

% get composite image
fList = regexpdir('/Users/derin/nanorodML/imageData/sem/spot5', '^.*\.tif$');
...
% save if no errors
save('/Users/derin/nanorodML/database/spot05circ50x.mat', 'results');
