% Spot 18 circular polarization 50x database entry
...
% Load in IRIS images
irisFname = '/Users/derin/nanorodML/imageData/circular/2015-6-15 z stacks/50x/c3_2/c3_2_MMStack.ome.tif';
...
% get composite image
fList = regexpdir('/Users/derin/nanorodML/imageData/sem/spot18', '^.*\.tif$');
...
% save if no errors
save('/Users/derin/nanorodML/database/spot18circ50x.mat', 'results');
