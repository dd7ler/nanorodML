% Spot 18 circular polarization 20x database entry
...
% Load 50x
temp = load('/Users/derin/nanorodML/database/spot18circ50x.mat');
fiftyx = temp.results;
...
% save if no errors
save('/Users/derin/nanorodML/database/spot18circ20x.mat', 'results');
