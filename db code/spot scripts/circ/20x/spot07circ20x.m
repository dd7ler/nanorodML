...
% Load in IRIS images
irisFname = '/Users/derin/nanorodML/imageData/circular/2015-6-15 z stacks/20x/c12_4/c12_4_MMStack.ome.tif';
...
% Load 50x
temp = load('/Users/derin/nanorodML/database/spot07circ50x.mat');
fiftyx = temp.results;
...
% save if no errors
save('/Users/derin/nanorodML/database/spot07circ20x.mat', 'results');
