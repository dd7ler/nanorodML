% Spot 33 circular polarization 20x database entry
...
% Load in IRIS images
irisFname = '/Users/derin/nanorodML/imageData/circular/2015-6-15 z stacks/20x/c56_1/c56_1_MMStack.ome.tif';
...
% Load 50x
temp = load('/Users/derin/nanorodML/database/spot33circ50x.mat');
fiftyx = temp.results;
...
% save if no errors
save('/Users/derin/nanorodML/database/spot33circ20x.mat', 'results');
